...
import { faHome, faPersonRunning, faBolt, faCamera, faRotate } from '@fortawesome/free-solid-svg-icons';
...
root.render(<App home={home} run={run} flash={flash} picture={picture} swap={swap} />);
